  ...
  return (
    <div className="nx-page">
      <header className="nx-page-header">
        <div>
          <p className="nx-section-label">Suivi client</p>
          <h1 className="nx-page-title">Relances</h1>
          <p className="nx-page-sub">Gerez vos rappels prioritaires et gardez une visibilite nette sur les prochaines actions.</p>
        </div>
